			...
			<Applications>
				<Application Id="App" Executable="$targetnametoken$.exe" EntryPoint="RECOIL.App">
					<uap:VisualElements
						...
						<uap:DefaultTile Wide310x150Logo="Assets\Wide310x150Logo.png" ShortName="RECOIL">
							<uap:ShowNameOnTiles>
						...
						<uap:Extension Category="windows.fileTypeAssociation">
							<uap:FileTypeAssociation Name="recoil">
								...
								<uap:SupportedFileTypes>
									...
									<!-- DDP, MPIC, MWIN, PNTG arbitrarily removed to workaround store submission error:
									...
									<xsl:for-each select="platform/format/ext[not(. = following::ext) and . != 'MSP' and . != 'SCR' and . != 'ATR' and . != 'CPT' and . != 'OBJ' and . != 'ODF' and . != 'RPM' and . != 'DDP' and . != 'MPIC' and . != 'MWIN' and . != 'PNTG']">
										<xsl:sort />
