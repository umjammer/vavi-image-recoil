						...
						<uap:Extension Category="windows.fileTypeAssociation">
							<uap:FileTypeAssociation Name="recoil">
								...
								<uap:SupportedFileTypes>
									...
									<!-- DDP, MPIC, MWIN arbitrarily removed to workaround store submission error:
									...
									<xsl:for-each select="platform/format/ext[not(. = following::ext) and . != 'MSP' and . != 'SCR' and . != 'ATR' and . != 'CPT' and . != 'OBJ' and . != 'ODF' and . != 'RPM' and . != 'DDP' and . != 'MPIC' and . != 'MWIN']">
										<xsl:sort />
